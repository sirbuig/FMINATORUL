...
namespace FMInatorul.Migrations
{
    ...
    [Migration("20240528113019_addIntrebRasp_and_Materie")]
    partial class addIntrebRasp_and_Materie
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMInatorul.Models.MaterieIntRas", b =>
                {
                    b.Property<int>("IntRas_id")
                        .HasColumnType("int");

                    b.Property<int>("Materie_id")
                        .HasColumnType("int");

                    b.HasKey("IntRas_id", "Materie_id");

                    b.HasIndex("Materie_id");

                    b.ToTable("MaterieIntRas");
                });
            ...
            modelBuilder.Entity("FMInatorul.Models.MaterieIntRas", b =>
                {
                    b.HasOne("FMInatorul.Models.IntrebariRasp", "IntrebariRasp")
                        .WithMany("MaterieIntRas")
                        .HasForeignKey("IntRas_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FMInatorul.Models.Materie", "Materie")
                        .WithMany("MaterieIntRas")
                        .HasForeignKey("Materie_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
